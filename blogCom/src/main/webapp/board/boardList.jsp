...
<body>
	...
	<div class="col-8">
	<a class="page-link" href="<%=request.getContextPath()%>/board/insertBoardForm.jsp">게시글 추가</a>
	<table class="table table-hover table-dark ">
		...
		<li class="page-item"><a class="page-link .active" href="<%=request.getContextPath()%>/board/boardList.jsp?currentPage=<%=currentPage-1%>&categoryName=<%=categoryName%>">이전</a></li>
			...
			<!--  마지막 페이지 ? 
			 ...
			 %>
			 <li class="page-item"><a class="page-link active" href="<%=request.getContextPath()%>/board/boardList.jsp?currentPage=<%=currentPage+1%>&categoryName=<%=categoryName%>">다음</a> </li>	
			 <% 
			 	}
			 %>
