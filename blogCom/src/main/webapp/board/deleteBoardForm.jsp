...
<body>
	<form method="post" action="<%=request.getContextPath()%>/board/deleteBoardAction.jsp?boardNo=<%=board.getBoardNo()%>">
		...
		<h1>게시글 삭제</h1>
			...
			<div class=".container-fluid">
				...
				<div><button class="btn btn-outline-light text-dark" type="submit"> 삭제</button></div>
			</div>
	</form>
